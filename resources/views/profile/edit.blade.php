...
<head>
    ...
    <style>
        ...
        .event-image-filter img {
            ...
            /* Adjust to match the purple hue */
        }
        ...
        .event-image-filter::after {
            ...
            /* Blends with the image, creating a tinted effect */
        }
...
<body class="text-white bg-gradient-univibe flex flex-col min-h-screen">
    ...
    <div class="flex-grow w-full relative z-10">
        ...
        @auth
            ...
            <div class="flex-grow w-full relative z-10">
                <div
                    class="bg-dark-card rounded-t-3xl pt-8 px-6 pb-24 relative z-0 -mt-2 flex flex-col items-center flex-grow">

                    <img src="https://randomuser.me/api/portraits/women/68.jpg" alt="Profile"
                        class="w-44 h-44 rounded-full object-cover shadow-md" />
                    ...
                    <div class="flex mt-2 text-yellow-400">
                        @for ($i = 0; $i < 5; $i++)
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                                ...
                                <path
                                    d="M12 .587l3.668 7.431 8.2 1.192-5.934 5.782 1.401 8.168L12 18.897l-7.335 3.863 1.401-8.168L.132 9.21l8.2-1.192z" />
                            </svg>
                        @endfor
                    </div>
                    ...
                    <div class="mt-6 space-y-4">
                        <div>
                            ...
                            <div
                                class="bg-white text-black rounded-full px-5 py-2.5 flex justify-between items-center mt-1">
                                <span class="min-w-[150px]">{{ auth()->user()->name }}</span> {{-- Added min-w here --}}
                        ...
                        <div>
                            ...
                            <div
                                class="bg-white text-black rounded-full px-5 py-2.5 flex justify-between items-center mt-1">
                                <span class="min-w-[150px]">{{ auth()->user()->email }}</span> {{-- Added min-w here --}}
                                <a href="#" class="text-purple-500 text-[15px]">Edit</a>
                            </div>
                        ...
                        <div>
                            ...
                            <div
                                class="bg-white text-black rounded-full px-5 py-2.5 flex justify-between items-center mt-1">
                                <span class="min-w-[150px]">••••••••••</span> {{-- Added min-w here --}}
                                <a href="#" class="text-purple-500 text-[15px]">Edit</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex justify-center space-x-3">
                <img src="{{ asset('badge-red.png') }}" class="w-14 h-16">
                <img src="{{ asset('badge-blue.png') }}" class="w-14 h-16">
                <img src="{{ asset('badge-orange.png') }}" class="w-14 h-16">
            </div>
    ...
    <nav
        ...
        <a href="/map"
            class="flex flex-col items-center {{ request()->is('map') ? 'text-purple-700' : 'text-gray-500' }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/events"
            class="flex flex-col items-center {{ request()->is('events') ? 'text-purple-700' : 'text-gray-500' }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <a href="/profile"
            class="flex flex-col items-center {{ request()->is('profile') ? 'text-purple-700' : 'text-gray-500' }}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mb-1" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
